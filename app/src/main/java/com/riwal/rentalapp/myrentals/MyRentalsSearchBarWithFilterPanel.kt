...
class MyRentalsSearchBarWithFilterPanel @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0, val firstDayOfWeek: Int) : BaseView(context, attrs, defStyleAttr) {
    ...
    interface Delegate {
        fun onBackButtonPressed(view: MyRentalsSearchBarWithFilterPanel)
        fun onFilterPanelToggled(view: MyRentalsSearchBarWithFilterPanel, isOpen: Boolean)
        fun onFilterChanged(view: MyRentalsSearchBarWithFilterPanel, newFilter: MyRentalsFilter)
    }
}