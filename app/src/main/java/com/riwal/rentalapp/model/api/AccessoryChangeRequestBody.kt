...
import com.riwal.rentalapp.model.api.AccessoryChangeRequestBody.Change
import com.riwal.rentalapp.model.api.AccessoryChangeRequestBody.ChangeField.*

data class AccessoryChangeRequestBody(
...
fun AccessoriesOnRent.differences(other: AccessoriesOnRent): List<Change> {
